...
# WebGL GPU signatures, tagged with the platform whose renderer string they
# actually are. "Direct3D11 ... ps_5_0" and "PCIe/SSE2" only exist on Windows
# and an ANGLE Metal renderer only on macOS, so the pool is filtered by
# `ds_identity.PLATFORM`: presenting a Windows GPU under a macOS User-Agent
# contradicts the same browser description the headers assert, and the
# challenge script evaluates exactly that.
_GPU_POOL = [
    {
        "platform": "Windows",
        "vendor": "Google Inc. (NVIDIA Corporation)",
        "model": "ANGLE (NVIDIA Corporation, NVIDIA GeForce RTX 5070/PCIe/SSE2, OpenGL ES 3.2)",
        "extensions": [
    ...
    },
    {
        ...
        "model": "ANGLE (Microsoft, Microsoft Basic Render Driver (0x0000008C) Direct3D11 vs_5_0 ps_5_0, D3D11)",
        "extensions": [
            "ANGLE_instanced_arrays",
            "EXT_blend_minmax",
            "EXT_clip_control",
    ...
    },
    {
        ...
        "model": "ANGLE (Apple, ANGLE Metal Renderer: Apple M2, Unspecified Version)",
        "extensions": [
            "ANGLE_instanced_arrays",
            "EXT_blend_minmax",
            "EXT_clip_control",
