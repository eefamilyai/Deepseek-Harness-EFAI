...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-sidebar-terminal TerminalMenuHeaderAction id \'session-log-download\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-effects EffectsSettingsRow id \'visual-effects\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-accounts AccountsSection',
      'client-ui-settings-advanced AdvancedSection',
      'client-ui-settings-general GeneralSection id \'general\'',
      'client-ui-settings-models ModelsSection id \'models\'',
      'client-ui-settings-plugins PluginsSettingsSection id \'plugins\'',
      'client-ui-settings-tools ToolsSection',
    ],
    replaceRisk: 'none',
