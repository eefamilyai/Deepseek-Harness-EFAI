...
export const zh = {
  ...
  // DSH-FORK(brand): phrases naming what the folded Turn's tool calls did.
  // EXIT: upstream gives the folded process row a content-derived label.
  'message.turnProcess.created': '新建了 {name}',
  'message.turnProcess.edited': '编辑了 {name}',
  'message.turnProcess.read': '读取了 {name}',
  'message.turnProcess.command': '运行了命令',
  'message.turnProcess.script': '运行了脚本',
  'message.turnProcess.scriptNamed': '运行了脚本：{label}',
  'message.turnProcess.search': '搜索了代码',
  'message.turnProcess.web': '进行了网页搜索',
  'message.turnProcess.fetch': '读取了网页',
  'message.turnProcess.plan': '更新了任务列表',
  'message.turnProcess.delegated': '委派了 {name}',
  'message.turnProcess.other': '调用了 {name}',
  'message.turnProcess.repeat': '{text} ×{count}',
  'message.turnProcess.more': '还有 {count} 项',
  'message.stopped': '已停止',
...
export const en = {
  ...
  // DSH-FORK(brand): phrases naming what the folded Turn's tool calls did.
  // EXIT: upstream gives the folded process row a content-derived label.
  'message.turnProcess.created': 'Created {name}',
  'message.turnProcess.edited': 'Edited {name}',
  ...
  'message.turnProcess.plan': 'updated the plan',
  'message.turnProcess.delegated': 'delegated to {name}',
  'message.turnProcess.other': 'called {name}',
  'message.turnProcess.repeat': '{text} ×{count}',
  'message.turnProcess.more': '{count} more',
