...
- `@deepseek-ai/dsh-token-usage-lifetime` — requires `sessionProjections` ([`packages/llm/token-usage-lifetime/src/index.ts`](../packages/llm/token-usage-lifetime/src/index.ts))
